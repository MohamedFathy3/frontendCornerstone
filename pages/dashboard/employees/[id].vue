              ...
              <div class="flex items-center space-x-6 mb-6 md:mb-0">
                <div class="relative">
                  <img 
                    ...
                    :alt="employee.name"
                    class="w-24 h-24 rounded-2xl object-cover border-4 border-white shadow-lg bg-gray-200"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <InfoCard 
                  ...
                  label="Postal Code"
                  :value="employee.post_nummer || 'N/A'"
                  color="amber"
                />
              </div>
              ...
              <div class="space-y-6">
                <div>
                  ...
                  <div class="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium"
                    :class="getJobTypeClass(employee.type_job)">
          ...
          <div class="space-y-8">
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8">
              ...
              <div class="flex flex-wrap gap-3" v-if="employee.languages && employee.languages.length > 0">
                <div 
                  v-for="(language, index) in employee.languages" 
                  :key="index"
                  class="inline-flex items-center px-4 py-2 bg-purple-100 text-purple-800 rounded-full text-sm font-medium"
                >
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8">
              ...
              <div class="space-y-3" v-if="employee.favorite_work && employee.favorite_work.length > 0">
                <div 
                  v-for="(work, index) in employee.favorite_work" 
                  :key="index"
                  class="flex items-center space-x-3 p-3 bg-yellow-50 rounded-xl border border-yellow-200"
                >
            ...
            <!-- Documents Section - التصميم المحسن -->
            <div class="bg-white rounded-3xl shadow-xl p-8">
              <div class="flex items-center space-x-3 mb-6">
                <div class="w-2 h-8 bg-red-500 rounded-full"></div>
                <h2 class="text-2xl font-bold text-gray-900">Documents & Files</h2>
              </div>
              
              <div class="space-y-6">
                <!-- Profile Photo -->
                <div v-if="employee.image" class="border-2 border-gray-200 rounded-2xl p-6 hover:border-red-300 transition-all duration-300 bg-gradient-to-r from-red-50 to-white">
                  <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div class="flex items-center space-x-4 flex-1">
                      <div class="relative">
                        <img 
                          :src="getImageUrl(employee.image)" 
                          :alt="'Profile photo of ' + employee.name"
                        ...
                        <div class="absolute -bottom-1 -right-1 bg-green-500 rounded-full p-1 border-2 border-white">
                          <Icon name="mdi:image" class="h-3 w-3 text-white" />
                        </div>
                      </div>
                      <div class="flex-1 min-w-0">
                        <h3 class="text-lg font-semibold text-gray-900 mb-1">Profile Photo</h3>
                        ...
                        <p class="text-xs text-green-600 font-medium mt-1 flex items-center">
                          <Icon name="mdi:check-circle" class="h-3 w-3 inline mr-1" />
                          Ready to download
                        </p>
                      </div>
                    </div>
                    <div class="flex items-center gap-2">
                      <button 
                        @click="previewFile(employee.image)"
                        class="btn btn-sm btn-outline-gray flex items-center gap-2 px-4 py-2 rounded-xl border border-gray-300 hover:border-gray-400 transition-colors"
                      >
                      ...
                      <button 
                        ...
                        class="btn btn-sm btn-primary flex items-center gap-2 px-4 py-2 rounded-xl bg-red-500 text-white hover:bg-red-600 transition-colors shadow-sm"
                      >
                ...
                <!-- CV/Resume -->
                <div v-if="employee.cv" class="border-2 border-gray-200 rounded-2xl p-6 hover:border-blue-300 transition-all duration-300 bg-gradient-to-r from-blue-50 to-white">
                  <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div class="flex items-center space-x-4 flex-1">
                      <div class="w-16 h-16 bg-blue-100 rounded-xl flex items-center justify-center border-2 border-white shadow-md">
                        <Icon name="mdi:file-pdf-box" class="h-8 w-8 text-blue-500" />
                      </div>
                      <div class="flex-1 min-w-0">
                        <h3 class="text-lg font-semibold text-gray-900 mb-1">CV / Resume</h3>
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <button 
                        ...
                        class="btn btn-sm btn-primary flex items-center gap-2 px-4 py-2 rounded-xl bg-blue-500 text-white hover:bg-blue-600 transition-colors shadow-sm"
                      >
                        <Icon name="mdi:download" class="h-4 w-4" />
                        Download
                      </button>
                ...
                <div v-if="employee.application" class="border-2 border-gray-200 rounded-2xl p-6 hover:border-green-300 transition-all duration-300 bg-gradient-to-r from-green-50 to-white">
                  <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                    <div class="flex items-center space-x-4 flex-1">
                      ...
                      <div class="flex-1 min-w-0">
                        <h3 class="text-lg font-semibold text-gray-900 mb-1">Application Document</h3>
                    ...
                    <div class="flex items-center gap-2">
                      <button 
                        @click="previewFile(employee.application)"
                        class="btn btn-sm btn-outline-gray flex items-center gap-2 px-4 py-2 rounded-xl border border-gray-300 hover:border-gray-400 transition-colors"
                      >
                        <Icon name="mdi:eye" class="h-4 w-4" />
                        Preview
                      ...
                      <button 
                        ...
                        class="btn btn-sm btn-primary flex items-center gap-2 px-4 py-2 rounded-xl bg-green-500 text-white hover:bg-green-600 transition-colors shadow-sm"
                      >
                        <Icon name="mdi:download" class="h-4 w-4" />
                        Download
                      </button>
                ...
                <div v-if="!employee.cv && !employee.application && !employee.image" 
                     class="text-center py-12 text-gray-500 border-2 border-dashed border-gray-300 rounded-2xl bg-gray-50">
                  <div class="w-20 h-20 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4">
                    <Icon name="mdi:file-remove" class="h-10 w-10 text-gray-400" />
                  </div>
                  <p class="text-lg font-medium text-gray-600">No Documents Available</p>
                  <p class="text-sm text-gray-500 mt-2">This employee hasn't uploaded any documents yet.</p>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white rounded-3xl shadow-xl p-8">
              ...
              <div class="space-y-4">
                ...
                <InfoCard 
                  ...
                  label="Account Type"
                  :value="employee.type_login || 'Employee'"
                  color="teal"
                  small
                />
                <InfoCard 
