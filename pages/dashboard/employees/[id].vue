<template>
    ...
    <div class="space-y-6">
        <!-- صورة الملف الشخصي -->
        <div v-if="employee.image" class="border-2 border-gray-200 rounded-2xl p-6 hover:border-red-300 transition-all duration-300 bg-gradient-to-r from-red-50 to-white hover:shadow-md cursor-pointer" @click="downloadFile(employee.image, 'profile-photo')">
        ...
        <!-- السيرة الذاتية -->
        <div v-if="employee.cv" class="border-2 border-gray-200 rounded-2xl p-6 hover:border-blue-300 transition-all duration-300 bg-gradient-to-r from-blue-50 to-white hover:shadow-md cursor-pointer" @click="downloadFile(employee.cv, 'cv-resume')">
            <div class="flex items-center space-x-4">
        ...
        <!-- مستند التقديم -->
        <div v-if="employee.application" class="border-2 border-gray-200 rounded-2xl p-6 hover:border-green-300 transition-all duration-300 bg-gradient-to-r from-green-50 to-white hover:shadow-md cursor-pointer" @click="downloadFile(employee.application, 'application')">
            <div class="flex items-center space-x-4">
